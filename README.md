...
(These failure modes are explored in depth in [What Pulling Espresso Taught Me About Building Enterprise AI Agents](https://levelup.gitconnected.com/what-pulling-espresso-taught-me-about-building-enterprise-ai-agents), which frames capability design as finding the right "grind size" — the variable that governs extraction quality in the whole system.)
